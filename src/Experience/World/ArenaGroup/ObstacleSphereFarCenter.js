...
export default class ObstacleSphereFarCenter {
  constructor() {
  ...
  setPhysics() {
    this.physics.setObstacleSphereFarCenterBody(this.meshPosition, this.meshQuaternion)
  }
  ...
  update() {    
    ...
    this.physics.obstacleSphereFarCenterBody.position.copy(this.mesh.position);
  }
}