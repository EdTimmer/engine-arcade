...
export default class ObstacleSphereFarBottom {
  constructor() {
  ...
  setPhysics() {
    this.physics.setObstacleSphereFarBottomBody(this.meshPosition, this.meshQuaternion)
  }
  ...
  update() {    
    ...
    this.physics.obstacleSphereFarBottomBody.position.copy(this.mesh.position);
  }
}